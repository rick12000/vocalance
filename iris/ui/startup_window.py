...
from iris.ui.utils.ui_thread_utils import schedule_ui_update_immediate, is_main_thread
from iris.ui.utils.ui_icon_utils import set_window_icon_with_parent_inheritance
...
class StartupWindow:
    ...
    def _show_impl(self) -> None:
        ...
        try:
            ...
            # Set icon
            from iris.ui.utils.ui_icon_utils import track_window_for_icon_management
