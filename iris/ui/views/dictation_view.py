...
class DictationView(BaseView):
    ...
    def _setup_manage_prompts_panel(self) -> None:
        ...
        from iris.ui.views.components.themed_components import ThemedScrollableFrame
    ...
    def _create_prompt_tile(self, prompt_data: Dict[str, Any], row_idx: int) -> None:
        ...
        from iris.ui.views.components.themed_components import BorderlessFrame, ThemedLabel, PrimaryButton, DangerButton
    ...
    def _edit_prompt(self, prompt_data: Dict[str, Any]) -> None:
        ...
        from iris.ui.views.components.themed_components import ThemedFrame
