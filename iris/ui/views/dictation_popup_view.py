...
from iris.ui.controls.dictation_popup_control import DictationPopupController, DictationPopupMode
...
class DictationPopupView:
    ...
    def append_llm_token(self, token: str) -> None:
        if self.llm_box and self.llm_box.winfo_exists():
            self.llm_box.insert("end", token)
