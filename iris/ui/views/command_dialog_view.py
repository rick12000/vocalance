...
class CommandEditDialog:
    ...
    def show(self) -> Tuple[Optional[str], Optional[str]]:
        ...
        try:
            ...
            # Edit title
            edit_title = ThemedLabel(
                edit_tile,
                text="Edit Command Phrase",
                bold=True,
                color=ui_theme.theme.text_colors.light
            )
            ...
            self.entry = ThemedEntry(
                edit_tile,
                width=ui_theme.theme.dimensions.entry_width_large
            )
            ...
            if self.command.is_custom:
                ...
                delete_desc = ThemedLabel(
                    delete_tile,
                    text="This is a custom command and can be safely deleted.",
                    color=ui_theme.theme.text_colors.light
                )
                ...
                delete_desc = ThemedLabel(
                    delete_tile,
                    text="This is a built-in command and cannot be deleted.",
                    color=ui_theme.theme.text_colors.light
                )
    ...
    def _on_delete(self, dialog):
        ...
        try:
            ...
            # Show confirmation
            from iris.ui.views.components import themed_dialogs as messagebox
