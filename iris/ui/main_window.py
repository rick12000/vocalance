...
from iris.ui.views.components.themed_components import ThemedButton, ThemedLabel, ThemedFrame, TransparentFrame, SidebarIconButton, SidebarButtonManager, CustomSidebarFrame
from iris.ui.utils.ui_assets import get_assets_path
from iris.ui.utils.logo_service import logo_service
from iris.ui.controls.commands_control import CommandsController
from iris.ui.controls.marks_control import MarksController
from iris.ui.controls.settings_control import SettingsController
from iris.ui.controls.sound_control import SoundController
from iris.ui.controls.dictation_control import DictationController
from iris.ui.controls.grid_control import GridController
from iris.ui.controls.system_control import SystemController
from iris.ui.controls.dictation_popup_control import DictationPopupController
from iris.ui.views.commands_view import CommandsView
from iris.ui.views.marks_view import MarksView
from iris.ui.views.settings_view import SettingsView
from iris.ui.views.sound_view import SoundView
from iris.ui.views.dictation_view import DictationView
from iris.ui.views.grid_view import GridView
from iris.ui.views.mark_view import MarkView
from iris.ui.views.dictation_popup_view import DictationPopupView
from iris.ui.views.components import themed_dialogs
...
class AppControlRoom:
    ...
    def _initialize_controllers(self):
        ...
        try:
            ...
            self.settings_controller = SettingsController(self.event_bus, self.event_loop, self.logger, self.config, settings_service)
    ...
    def _initialize_specialized_views(self):
        ...
        try:
            ...
            self.dictation_popup_view = DictationPopupView(
                parent_root=self.root,
                controller=self.dictation_popup_controller
            )
    ...
    def _setup_main_window(self):
        ...
        try:
            ...
            from iris.ui.utils.ui_icon_utils import set_window_icon_robust, track_window_for_icon_management
    ...
    def _build_ui(self):
        ...
        self.bg_frame.grid_columnconfigure(0, weight=0, minsize=ui_theme.theme.sidebar_layout.grid_column_minsize)  # Sidebar column matches sidebar width
    ...
    def _create_sidebar_logo(self):
        ...
        self.sidebar_logo.grid(
            row=2, column=0, 
            pady=(sidebar_config.logo_padding_top, sidebar_config.logo_padding_bottom)
        )
    ...
    def create_header(self):
        ...
        self.header.grid(
            ...
            padx=header_config.frame_padx, 
            pady=header_config.frame_pady
        )
        ...
        self.header_label.grid(
            row=0, column=0, 
            padx=header_config.title_padx, 
            pady=(header_config.title_y_offset, 0), 
            sticky="w"
        )
    ...
    def cleanup_controllers(self):
        ...
        try:
            controllers = [
                ...
                'system_controller', 'dictation_popup_controller'
            ]
