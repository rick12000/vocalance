...
class _CenteredGradientLabel(GradientTextMixin, QLabel):
    """Gradient label with center alignment support for custom paint."""
...
class Tile(BaseContainer):
    """Tile for instructions or info cards with rounded border and gradient title."""
    ...
    def __init__(self, title: str, content: str, parent: Optional[QWidget] = None) -> None:
        ...
        title_label = _CenteredGradientLabel(title)
